# micro-optimization: CPython local vars are faster than globals; thus we get a
# small but easily measurable speedup by wrapping the whole thing in a function
def main():
